...
from project.api.depends import database, room_type_repo

router = APIRouter()


@router.get("/all_room_types", response_model=list[RoomTypeSchema], status_code=status.HTTP_200_OK)
...
@router.get("/room_type/{room_type_id}", response_model=RoomTypeSchema, status_code=status.HTTP_200_OK)
