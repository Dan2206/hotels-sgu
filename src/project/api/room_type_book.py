...
from project.api.depends import database, room_type_book_repo

router = APIRouter()


@router.get("/all_room_type_books", response_model=list[RoomTypeBookSchema], status_code=status.HTTP_200_OK)
...
@router.get("/room_type_book/{room_type_book_id}", response_model=RoomTypeBookSchema, status_code=status.HTTP_200_OK)
